...
ALLOWED_HANDLERS = {
    ...
    "3s_arm", "sonic_mania_mister", "mister_quake", "mister_duke3d", "dreamster", "zaparoo_frontend", "misterfin", "mister_monitor", "user_profiles", "collection_launcher", "mister_hifi", "disc_tools", "solarus", "mister_dvd", "dvd_player", "misterzine_frontend", "wallpaper_pack", "rom_install",
