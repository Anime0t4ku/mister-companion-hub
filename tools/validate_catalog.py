...
ALLOWED_HANDLERS = {
    ...
    "3s_arm", "sonic_mania_mister", "mister_quake", "mister_duke3d", "dreamster", "zaparoo_frontend", "misterfin", "user_profiles", "collection_launcher", "mister_hifi", "solarus", "wallpaper_pack", "rom_install",
